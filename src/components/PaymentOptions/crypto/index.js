...
const CryptoInstructions = () => (
  <div className={`mt-2 mb-2 ${"qr-terms"} border rounded-3`}>
    <ol>
      <li>
          ...
          <div className="mt-3">
            {user.crypto_address ? (
              <>
                ...
                <>
                  <div
                    className={`d-flex justify-content-between ${"ac-cc-title"}`}
                  >
                    <h6 className="scan-text">Scan Code</h6>
                  </div>
                  ...
                  <button
                    disabled={refresh}
                    type="button"
                    className="btn btn-dark w-100 rounded-pill mt-2 mb-1 mx-auto"
                    onClick={() => {
              ...
              <>
                <button
                  disabled={loading}
                  type="button"
                  className={`btn btn-dark w-100 rounded-pill ${"btn-af-pay"} mt-1 mb-1`}
