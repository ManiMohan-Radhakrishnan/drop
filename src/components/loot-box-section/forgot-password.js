...
import { forgotPasswordApi } from "../../api/base-methods";
...
const ForgotPassword = ({
  ...
  return (
    <Modal
      show={show}
      animation={false}
      contentClassName="forgot-password-modal forgot-password-modal"
      className="forgot-password-modal-main"
      centered
    >
      <Modal.Header
        className="forgot-password-modal-header"
        onHide={toggleModal}
        closeButton
        closeVariant="white"
      >
      ...
      <Modal.Body className="forgot-password-modal-body">
        {success ? (
          ...
          <>
            ...
            <div className="button-block mt-1">
              <button
                disabled={loading}
                type="button"
                className="bl_btn"
